                            ...
                            <div class="classynav">
                                <ul>
                                  ...
                                  <!--   <li><a href="albums-store.jsp">Store</a></li> -->
                                    <li><a href="#">Browse</a>
                                        <ul class="dropdown">
                                            <li><a href="albums-store.jsp">Accordian</a></li>
                                            <li><a href="albums-store.jsp">Bass</a></li>
                                            <li><a href="albums-store">Piano</a>
                                            <li><a href="albums-store">Violin</a>
                                            <li><a href="#">Guitar</a>
                                                <ul class="dropdown">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="hero-slides-content text-center">
                                ...
                                <a data-animation="fadeInUp" data-delay="500ms" href="login.jsp" class="btn oneMusic-btn mt-50">Login to continue! <i class="fa fa-angle-double-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="hero-slides-content text-center">
                                <h6 data-animation="fadeInUp" data-delay="100ms">Latest </h6>
                                <h2 data-animation="fadeInUp" data-delay="300ms">Music Instruments <span>Music Instruments</span></h2>
                                <a data-animation="fadeInUp" data-delay="500ms" href="login.jsp" class="btn oneMusic-btn mt-50">Login to continue! <i class="fa fa-angle-double-right"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-2">
                    <div class="single-album-area wow fadeInUp" data-wow-delay="100ms">
                        <div class="album-thumb">
                            ...
                            <!-- Play Icon -->
                            <div class="play-icon">
                                <a href="#" class="video--play--btn"><span class="icon-shopping-cart"></span></a>
                            </div>
                        </div>
						...
						<div class="play=icon">
							<p>
								<a href="productDisplay" class="video--play--btn"><span
									class="icon-shopping-cart"></span> </a><span class="quantity">1</span>
							</p>
						</div>
                        </div>
                    </div>
